...
private:
    ...
    void visita2(grafoMat<int,int>&g,typename grafoMat<int,int>::nodo n, int &somma, int &counter, int& lunghezza, nodo_visita visitati[]);
...
void util_grafo::visita2(grafoMat<int, int> &g, typename grafoMat<int, int>::nodo n, int &somma, int &counter, int& lunghezza, nodo_visita visitati[]) {
    if (lunghezza<2)
    {
            //VISITO IL GRAFO
