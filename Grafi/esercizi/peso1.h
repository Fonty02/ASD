...
private:
    ...
    void visitaPesata(grafoMat<T,int>&g,typename grafoMat<T,int>::nodo a,typename grafoMat<T,int>::nodo b,int& lunghezzaTotale,int& lunghezzaAttuale, int& numeroCammini, nodo_visita visitati[]);
};

template <class T>
cammino_pesato peso_grafo<T>::cammini1(grafoMat<T, int> &g, typename grafoMat<T, int>::nodo a, typename grafoMat<T, int>::nodo b) {
    cammino_pesato c;
    c.mediaLunghezza=0;
    c.numeroCammini=0;
    if (!g.vuoto())
...
template <class T>
void peso_grafo<T>::visitaPesata(grafoMat<T, int> &g, typename grafoMat<T, int>::nodo a, typename grafoMat<T, int>::nodo b, int &lunghezzaTotale,  int &lunghezzaAttuale, int &numeroCammini, nodo_visita visitati[]) {
