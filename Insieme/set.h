#include <ostream>
#include "../Dizionario/hashtableChiuso.h"
 ...
 * POST CONDIZIONE: Insieme=Insieme di partenza + {v} se v non appartiene all'insieme, Insieme=Insieme di partenza altrimenti
 */
template<class T>
...
/*
 * Verifica esistenza di un elemento nell'insieme
 * POST CONDIZIONE: Return true se "e" appartiene all'insieme, FALSE altrimenti
 */
template<class T>
...
/*
 * Inserimento di un nodo nell'insieme
 * POST CONDIZIONE: Insieme=Insieme di partenza \ {v} se v appartiene all'insieme, Insieme=Insieme di partenza altrimenti
 */
template<class T>
 ...
 * POST CONDIZIONE: Unione con l'insieme B
 */
template<class T>
 ...
 * POST CONDIZIONE: Intersezione con l'insieme B
 */
template<class T>
 ...
 * POST CONDIZIONE: Differenza con l'insieme B
 */
template<class T>
